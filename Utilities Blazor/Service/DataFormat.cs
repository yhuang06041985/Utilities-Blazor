using Utilities_Blazor.Service;
using Utilities_Blazor.Data;
...
namespace Utilities_Blazor.Service
{
  ...
  public class DataFormat : IDataFormat
  {
    ...
    public CurrentDto FormatCurrentData(Current currentWeather, CurrentDto currentData)
    {
      ...
      currentData.Temperature = currentWeather.temperature_2m.ToString();
      currentData.TemperatureLike = currentWeather.apparent_temperature.ToString() ;
      currentData.WindSpeed = "Wind: " + currentWeather.wind_speed_10m.ToString() + " mph";
      currentData.Description = weatherCode.Description?? string.Empty;
      currentData.IconUrl = weatherCode.IconUrl?? string.Empty;
      currentData.RelativeHumidity = "Humidity:" + currentWeather.relative_humidity_2m.ToString() + "%";
      currentData.Precipitation = "Precipitation: " + currentWeather.precipitation.ToString() + "%";
